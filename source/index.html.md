...
<h3 id="post__v1_indices-parameters">Parameters</h3>


|Parameter|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|object|true|No description|
|» name|body|string|true|Reference name for this index.|
|» code|body|string|true|Unique identifier for this index.|
|» weighting_method|body|string|true|Defines how the constituants of this index are combined in order to calculate it's price. See http://www.investopedia.com/terms/e/equalweight.asp and http://www.investopedia.com/terms/m/marketweight.asp for a detailed explanation.|
...
|» quote_currency_id|body|integer|true|The currency in which this index is quoted. The currency must be quotable.|
|» start_date|body|integer|true|The starting date from which the price of index is calculated. Format is UTC+0 timestamp.|
|» start_value|body|integer|true|The initial value of the index. It's an integer and it's usually a very simple number to start with like 1000|
|» definition|body|object|false|List of filters defining how a dynamic index's suggestions are made.|
|»» min_market_cap_usd|body|string|false|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter.|
|»» max_market_cap_usd|body|string|false|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter.|
|»» min_daily_volume_ratio|body|number|false|Leave null to ignore. Min of volume/supply sum by last 30 days, index will only contain pairs which match this filter.)|
|»» min_public_float|body|number|false|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter. Value from 0 to 1.)|
|»» max_currencies|body|integer|false|Leave null to ignore. Maximum amount of currencies to be suggested for the index.|
|»» mineable|body|boolean|false|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter.|
|»» exchange_ids|body|[integer]|false|Leave null to ignore. The list of exchanges included in this index.|
|»» *anonymous*|body|object|false|No description|
|»»» mineable|body|null,boolean|true|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter.|
|»» *anonymous*|body|object|false|No description|
|»»» min_market_cap_usd|body|string|true|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter.|
|»» *anonymous*|body|object|false|No description|
|»»» max_market_cap_usd|body|string|true|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter.|
|»» *anonymous*|body|object|false|No description|
|»»» min_daily_volume_ratio|body|number|true|Leave null to ignore. Min of volume/supply sum by last 30 days, index will only contain pairs which match this filter.)|
|»» *anonymous*|body|object|false|No description|
|»»» min_public_float|body|number|true|Leave null to ignore. Suggestions for the index will only contain pairs which match this filter. Value from 0 to 1.)|
|»» *anonymous*|body|object|false|No description|
|»»» exchange_ids|body|[integer]|true|Leave null to ignore. The list of exchanges included in this index.|
...
<h3 id="post__v1_indices-responses">Responses</h3>


|Status|Meaning|Description|Schema|
|---|---|---|---|
|201|[Created](https://tools.ietf.org/html/rfc7231#section-6.3.2)|The newly created index|Inline|
|400|[Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)|- Max number of constituents condition failed.
- There are no pairs that match given conditions.
- One or multiple "pair_ids" are not consistent with "quote_currency_id", ie. are not quotable in that currency
- The "quote_currency_id" doesn't map to a "quotable" currency
- You did not provide a definition for a "dynamic" index
- You provided a definition for a "static" index|Inline|
|409|[Conflict](https://tools.ietf.org/html/rfc7231#section-6.5.8)|- An index with the same "code" already exists|Inline|


<h3 id="post__v1_indices-responseschema">Response Schema</h3>
...
|Name|Type|Required|Description|
|---|---|---|---|
|» data|object|true|Main entity of the MithrilX system, indices group crypto currencies the same way the S&P500 groups the US 500 top companies.|
|»» id|integer|true|No description|
|»» name|string|true|Reference name for this index.|
|»» code|string|true|Unique identifier for this index.|
|»» weighting_method|string|true|Defines how the constituants of this index are combined in order to calculate it's price. See http://www.investopedia.com/terms/e/equalweight.asp and http://www.investopedia.com/terms/m/marketweight.asp for a detailed explanation.|
...
*Test dynamic index definition and return suitable constituents if test was successful*
...
<h3 id="post__v1_indices_test-parameters">Parameters</h3>
...
<h3 id="post__v1_indices_{id_or_code}_rebalance-responses">Responses</h3>


|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|The index decorated with rebalanced index pairs|Inline|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|- No corresponding index found for this id|Inline|


<h3 id="post__v1_indices_{id_or_code}_rebalance-responseschema">Response Schema</h3>
...
<h3 id="post__v1_indices_{id_or_code}_pairs_{pair_id_or_code}-responses">Responses</h3>


|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|The index with added pair|Inline|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|- No corresponding index found for this id|Inline|


<h3 id="post__v1_indices_{id_or_code}_pairs_{pair_id_or_code}-responseschema">Response Schema</h3>
...
<h3 id="delete__v1_indices_{id_or_code}_pairs_{pair_id_or_code}-responses">Responses</h3>


|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|The index with deleted pair|Inline|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|- No corresponding index found for this id|Inline|


<h3 id="delete__v1_indices_{id_or_code}_pairs_{pair_id_or_code}-responseschema">Response Schema</h3>
...
```shell
# You can also use wget
curl -X GET https://api-mithril-x-staging.herokuapp.com/v1/users \
  -H 'Accept: application/json'
...
```http
GET https://api-mithril-x-staging.herokuapp.com/v1/users HTTP/1.1
Host: api-mithril-x-staging.herokuapp.com
...
$.ajax({
  url: 'https://api-mithril-x-staging.herokuapp.com/v1/users',
  method: 'get',
...
fetch('https://api-mithril-x-staging.herokuapp.com/v1/users',
{
  method: 'GET',
...
result = RestClient.get 'https://api-mithril-x-staging.herokuapp.com/v1/users',
  params: {
  }, headers: headers
...
r = requests.get('https://api-mithril-x-staging.herokuapp.com/v1/users', params={
...
```java
URL obj = new URL("https://api-mithril-x-staging.herokuapp.com/v1/users");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
<h3 id="get__v1_users-parameters">Parameters</h3>
...
<h3 id="get__v1_users-responses">Responses</h3>
...
<h3 id="get__v1_users-responseschema">Response Schema</h3>
...
```shell
# You can also use wget
curl -X POST https://api-mithril-x-staging.herokuapp.com/v1/users \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
```http
POST https://api-mithril-x-staging.herokuapp.com/v1/users HTTP/1.1
Host: api-mithril-x-staging.herokuapp.com
Content-Type: application/json
Accept: application/json
...
result = RestClient.post 'https://api-mithril-x-staging.herokuapp.com/v1/users',
  params: {
  }, headers: headers
...
r = requests.post('https://api-mithril-x-staging.herokuapp.com/v1/users', params={
...
<h3 id="post__v1_users-parameters">Parameters</h3>
...
|» email|body|string|false|The user email address.|
|» role|body|string|false|The user role one of "admin" or "consumer".|
|» login|body|string|false|The login of the user, can be empty for consumer role users.|
|» token|body|string|false|The security token that can be used to perform authorized requests.|
|» password|body|string|false|The user password, can be specified when register new user. Never returned.|
...
<h3 id="post__v1_users-responses">Responses</h3>
...
<h3 id="post__v1_users-responseschema">Response Schema</h3>
...
```shell
# You can also use wget
curl -X GET https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail} \
  -H 'Accept: application/json'
...
```http
GET https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail} HTTP/1.1
Host: api-mithril-x-staging.herokuapp.com
...
$.ajax({
  url: 'https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail}',
  method: 'get',
...
fetch('https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail}',
{
  method: 'GET',
...
result = RestClient.get 'https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail}',
  params: {
  }, headers: headers
...
r = requests.get('https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail}', params={
...
```java
URL obj = new URL("https://api-mithril-x-staging.herokuapp.com/v1/users/{id_or_mail}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
<h3 id="get__v1_users_{id_or_mail}-parameters">Parameters</h3>
...
<h3 id="get__v1_users_{id_or_mail}-responses">Responses</h3>


|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|The corresponding user|Inline|


<h3 id="get__v1_users_{id_or_mail}-responseschema">Response Schema</h3>
...
```shell
# You can also use wget
curl -X DELETE https://api-mithril-x-staging.herokuapp.com/v1/users/{id} \
  -H 'Accept: application/json'
...
```http
DELETE https://api-mithril-x-staging.herokuapp.com/v1/users/{id} HTTP/1.1
Host: api-mithril-x-staging.herokuapp.com
...
$.ajax({
  url: 'https://api-mithril-x-staging.herokuapp.com/v1/users/{id}',
  method: 'delete',
...
fetch('https://api-mithril-x-staging.herokuapp.com/v1/users/{id}',
{
  method: 'DELETE',
...
result = RestClient.delete 'https://api-mithril-x-staging.herokuapp.com/v1/users/{id}',
  params: {
  }, headers: headers
...
r = requests.delete('https://api-mithril-x-staging.herokuapp.com/v1/users/{id}', params={
...
```java
URL obj = new URL("https://api-mithril-x-staging.herokuapp.com/v1/users/{id}");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("DELETE");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
|Parameter|In|Type|Required|Description|
|---|---|---|---|---|
|id|path|integer|true|The resource's identifier|
...
|Status|Meaning|Description|Schema|
|---|---|---|---|
|202|[Accepted](https://tools.ietf.org/html/rfc7231#section-6.3.3)|Accepted when successfully deleted|Inline|
